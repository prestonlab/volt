...
You'll see a popup from Unity asking for the run settings. Ensure that the screen resolution is set to `1024x768` and that the graphics quality is set to `Good`. Next, click `Play!` and the experiment will begin. 
...
| 2  | JA  | string  | Participant Number  |
